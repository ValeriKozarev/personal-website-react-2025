        ...
        <div className="max-w-4xl mx-auto">
            ...
            <CollapsibleSection>
              <div className="space-y-8">
                ...
                <WorkExperienceCard
                  ...
                  timeStart={"Aug 2020"}
                  timeEnd={"Jan 2022"}
                  summary={["Rapidly delivered new features to live users during the COVID-19 pandemic. Coordinated with various stakeholders to enhance vaccine information capture-and-reconciliation workflows within the MyChart COVID-19 feature, a high-traffic feature available to millions of users.", "Migrated internal web app from Angular 1.x to Angular 12 and established CI/CD pipeline via GitLab to improve code maintainability and accelerate feature delivery timelines.", "Served as lead engineer and primary business partner contact for a novel telehealth self-triage feature, owning full-stack development and project management. Designed and implemented a dynamic decision-tree traversal engine for symptom-based care routing.", "Refactored core workflows around patient data capture, wrote a comprehensive new testing suite, and created new internal documentation to facilitate knowledge-sharing."]}
          ...
          <section className="mb-16">
            ...
            <CollapsibleSection collapsedHeight="400px">
              ...
              <ProjectCard
                title="Harmonic"
                description="A Python CLI tool for DJs to find compatible tracks using the Spotify API. Given a BPM and Camelot key (or a source track), harmonic searches an artist's catalog or your Spotify playlists and returns ranked recommendations for your next mix."
                technologies={["Python"]}
                projectUrl="https://github.com/ValeriKozarev/harmonic"
              />
              <ProjectCard
                title="HYPR-VISR"
